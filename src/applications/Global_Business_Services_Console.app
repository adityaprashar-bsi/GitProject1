...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <description>Console view for GBS team</description>
    ...
    <footerColor>#a3a3a3</footerColor>
    <headerColor>#f5f5f5</headerColor>
    ...
    <label>Global Business Services Console</label>
    <listPlacement>
        <location>full</location>
    </listPlacement>
    <listRefreshMethod>refreshListRows</listRefreshMethod>
    <logo>SharedDocuments/Beam_Suntory_Logo.png</logo>
    <primaryTabColor>#cc0000</primaryTabColor>
